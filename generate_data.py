        ...
        if(book["id"] != other_book):
            ...
            if this_link == None:
                ...
                if inverse_link == None:
                    ...
                    book_links.append({"id": book["id"] + "_" + other_book, "source": book["id"], "target": other_book, "members": common_members, "value": len(common_members)})
member_links = []
for member in members:
        ...
        if(member["id"] != other_member):
            ...
            if this_link == None:
                ...
                if inverse_link == None:
                    ...
                    member_links.append({"id": member["id"] + "_" + other_member, "source": member["id"], "target": other_member, "value": len(common_books), "books": common_books})
